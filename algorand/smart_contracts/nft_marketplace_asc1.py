...
from algorand.marketplace_interfaces import NFTMarketplaceInterface
...
class NFTMarketplaceASC1(NFTMarketplaceInterface):
    ...
    def buy(self):
        ...
        return Seq([
            ...
            #     # TxnField.config_asset: App.globalGet(self.Variables.asa_id),
            #     TxnField.config_asset: Txn.assets[0],
            #     # TxnField.config_asset_manager: asaOwner,
            #     TxnField.config_asset_manager: App.globalGet(self.Variables.asa_owner),
            #     # TxnField.config_asset_clawback: App.globalGet(self.Variables.asa_owner),
